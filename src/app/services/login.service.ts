...
export class LoginService {
  ...
  private readonly VERIFY_URL = this.env.apiRestDomain + this.env.adminContext + '/verify'

  // Observable modal action
  actionModal$ = this._actionModal.asObservable();

  constructor(private http: HttpClient, private env: EnvService, private jwtHelper: JwtHelperService
  ) { }
